...
int dsp_setup(void)
{
  ...
  myGLCD.fillCircle(WHEEL_X0,WHEEL_Y0,25);
  myGLCD.drawLine(WHEEL_X0-WHEEL_R1,WHEEL_Y0,WHEEL_X0+WHEEL_R1,WHEEL_Y0);
  myGLCD.drawLine(WHEEL_X0,WHEEL_Y0,WHEEL_X0,WHEEL_Y0-WHEEL_R1);
